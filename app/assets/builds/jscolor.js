(() => {
  ...
  // app/javascript/jscolor.js
  var require_jscolor = __commonJS({
    "app/javascript/jscolor.js"(exports, module) {
      (function(global, factory) {
        ...
        var jscolor = function() {
          var jsc = {
            ...
            setDataAttr: function(el, name, value2) {
              var attrName = "data-" + name;
            ...
            setBorderRadius: function(elm, value2) {
              jsc.setStyle(elm, { "border-radius": value2 || "0" });
            },
            setBoxShadow: function(elm, value2) {
              jsc.setStyle(elm, { "box-shadow": value2 || "none" });
            },
            ...
            redrawPosition: function() {
              ...
              if (thisObj.container !== window2.document.body) {
            ...
            _drawPosition: function(thisObj, x, y, positionValue, contractShadow) {
              ...
              if (
                ...
                Math.round(parseFloat(jsc.picker.wrap.style.left)) !== Math.round(x) || Math.round(parseFloat(jsc.picker.wrap.style.top)) !== Math.round(y)
              ) {
            ...
            pub: function(targetElement, opts) {
              ...
              this.channel = function(name, value2) {
                ...
                if (value2 === void 0) {
                  ...
                  switch (name.toLowerCase()) {
                    case "r":
                      res = this.fromRGBA(value2, null, null, null);
                      break;
                    case "g":
                      res = this.fromRGBA(null, value2, null, null);
                      break;
                    case "b":
                      res = this.fromRGBA(null, null, value2, null);
                      break;
                    case "h":
                      res = this.fromHSVA(value2, null, null, null);
                      break;
                    case "s":
                      res = this.fromHSVA(null, value2, null, null);
                      break;
                    case "v":
                      res = this.fromHSVA(null, null, value2, null);
                      break;
                    case "a":
                      res = this.fromHSVA(null, null, null, value2);
                      break;
                    default:
              ...
              function setOption(option, value2) {
                ...
                if (jsc.enumOpts.hasOwnProperty(option)) {
                  ...
                  if (jsc.enumOpts[option].indexOf(value2) === -1) {
                    throw new Error("Option '" + option + "' has invalid value: " + value2);
                  }
                }
              ...
              if (jsc.isButton(this.targetElement)) {
                ...
                if (jsc.isButtonEmpty(this.targetElement)) {
                  ...
                  this.targetElement.appendChild(window2.document.createTextNode("\xA0"));
 ...
 */
//# sourceMappingURL=/assets/jscolor.js.map
